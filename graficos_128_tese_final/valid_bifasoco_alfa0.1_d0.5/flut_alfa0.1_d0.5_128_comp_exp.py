...
ax.set_ylabel("$u_{rms}$ , $v_{rms} \, [m/s]$", fontsize=18)
#dimensao dos eixos
ax.axis([0.0, 0.01, 0.0, 0.075])
#grafico 1
#ax.plot(r_1, v_1,
...
#grafico 1
ax.plot(r_5, v_5,
        label='$u_{rms} \,\, \\alpha = 0.1$%  $d_b = 500 \, \\mu m$ ',
        color='blue',
        linewidth=1,
        linestyle='-')       
#grafico 2
ax.plot(r_7, v_7,
        label='$u_{rms}$ Pang e Wei (2013)',
        color='white',
        linewidth=2,
        linestyle= '',
        marker = '^',
...
ax.plot(r_4, v_4,
        ...
        markeredgecolor = 'black')       
#colocar legenda
ax.legend(loc='upper center', scatterpoints=1)
#ajustar espacamento
fig.tight_layout()
#salvar a figura
plt.savefig('flut_alfa0.1_d0.5_128_comp_exp.pdf',
            format='pdf')
plt.savefig('flut_alfa0.1_d0.5_128_comp_exp.png',
            format='png')