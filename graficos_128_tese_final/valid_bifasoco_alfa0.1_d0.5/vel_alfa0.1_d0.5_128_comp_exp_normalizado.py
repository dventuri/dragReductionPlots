...
v_1 = v_1/0.0302353
#caso5
#r_5, v_5 = np.loadtxt("averages_sym.curve",
#                      dtype='float',
#                      skiprows=0,
#                      delimiter=' ',
#                      unpack=True)
...
#v_5 = v_5/0.030549203
#caso2
#r_2, v_2 = np.loadtxt("u_mono_128_dt10(-4)_novo_180000.curve",
#                      dtype='float',
#                      skiprows=0,
#                      delimiter=' ',
#                      unpack=True)
...
#v_3 = v_3*0.03
#caso4
#r_4, v_4 = np.loadtxt("dns_yu_2004.csv",
#                      dtype='float',
#                      skiprows=0,
#                      delimiter=' ',
#                      unpack=True)
...
fig.tight_layout()
#salvar a figura
plt.savefig('vel_alfa0.1_d0.5_128_comp_exp_normalizado_final1.pdf',
            format='pdf')
plt.savefig('vel_alfa0.1_d0.5_128_comp_exp_normalizado_final1.png',
            format='png')