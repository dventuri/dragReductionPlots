...
#v_1 = v_1/0.030487242
#caso2
r_2, v_2 = np.loadtxt("u_average_bif_alfa0.1_d0.5_172000.curve",
                      dtype='float',
                      skiprows=0,
                      delimiter=' ',
                      unpack=True)
...
#v_2 = v_2/0.030237111
#caso5
r_5, v_5 = np.loadtxt("u_average_bif_alfa0.5_d0.5_195000.curve",
                      dtype='float',
                      skiprows=0,
                      delimiter=' ',
                      unpack=True)
...
fig.tight_layout()
#salvar a figura
plt.savefig('vel_comp_128_abs_var_alfa_d05_teste1111111.pdf',
            format='pdf')
#plt.savefig('vel_comp_128_abs_var_alfa_d05.png',
#            format='png')