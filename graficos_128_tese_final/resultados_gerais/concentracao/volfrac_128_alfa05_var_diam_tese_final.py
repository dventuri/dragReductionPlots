...
#v_1 = v_1/0.030236987
#caso2
r_2, v_2 = np.loadtxt("volfrac_alfa0.5_d0.1_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#v_7 = v_7*0.03
#caso3
r_3, v_3 = np.loadtxt("vol_frac_alfa0.5_d0.2_180000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#v_3 = v_3
#caso1
r_5, v_5 = np.loadtxt("volfrac_alfa0.5_d0.5_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
ax.set_ylabel("Fração volumétrica do gás", fontsize=18)
#dimensao dos eixos
ax.axis([0.9, 150.0, 0.0, 0.06])
...
ax.annotate('I', xy=(12.5, 0.054), xytext=(3.0, 0.054), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
ax.annotate('II', xy=(12.5, 0.054), xytext=(12.5, 0.054), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
ax.annotate('III', xy=(12.5, 0.054), xytext=(37.0, 0.054), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
ax.annotate('IV', xy=(12.5, 0.054), xytext=(80.0, 0.054), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
#grafico 2
#ax.plot(r_7, v_7,
...
fig.tight_layout()
#salvar a figura
plt.savefig('volfrac_128_alfa05_var_diam_tese_final_logx_01.pdf',
            format='pdf')
plt.savefig('olfrac_128_alfa05_var_diam_tese_final_logx_01.png',
            format='png')
