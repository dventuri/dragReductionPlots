...
#v_1 = v_1/0.030236987
#caso2
r_2, v_2 = np.loadtxt("volfrac_alfa_0.1_d0.1_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#v_7 = v_7*0.03
#caso3
r_3, v_3 = np.loadtxt("volfrac_alfa_0.1_d0.2_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#dimensao dos eixos
ax.axis([0.9, 150.0, -0.00005, 0.035])
...
ax.annotate('I', xy=(12.5, 0.032), xytext=(3.0, 0.032), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
ax.annotate('II', xy=(12.5, 0.033), xytext=(14.5, 0.032), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
ax.annotate('III', xy=(12.5, 0.033), xytext=(37.0, 0.032), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
ax.annotate('IV', xy=(12.5, 0.033), xytext=(80.0, 0.032), size='16'
#            arrowprops=dict(facecolor='black', shrink=0.05),
            )
#grafico 2
#ax.plot(r_7, v_7,
...
fig.tight_layout()
##salvar a figura
#plt.savefig('volfrac_128_alfa01_var_diam_tese_final_01.pdf',
#            format='pdf')
#plt.savefig('volfrac_128_alfa01_var_diam_tese_final_01.png',
#            format='png')
