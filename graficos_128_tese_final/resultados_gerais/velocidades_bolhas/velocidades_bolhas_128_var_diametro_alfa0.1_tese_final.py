...
ax.set_ylabel("$\overline{u}_b \,\, [m/s]$", fontsize=16)
#dimensao dos eixos
...
fig.tight_layout()
#salvar a figura
#plt.savefig('vel_bolhas_alfa0.1_var_diametro_tese_final.pdf',
#            format='pdf')
#plt.savefig('vel_bolhas_alfa0.1_var_diametro_tese_final.png',
#            format='png')