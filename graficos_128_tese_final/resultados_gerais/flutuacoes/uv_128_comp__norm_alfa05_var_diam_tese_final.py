...
#caso1
r_5, v_5 = np.loadtxt("uv_alfa0.5_d0.5_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#caso2
r_2, v_2 = np.loadtxt("uv_alfa0.5_d0.1_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#v_7 = v_7/(0.03*0.3)
#caso3
r_3, v_3 = np.loadtxt("uv_alfa0.5_d0.2_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
fig.tight_layout()
#salvar a figura
#plt.savefig('uv_comp_128_norm_alfa05_var_diam_tese_final.pdf',
#            format='pdf')
#plt.savefig('uv_comp_128_norm_alfa05_var_diam_tese_final.png',
#            format='png')            
