...
v_1 = v_1/0.030236987
#caso2
r_2, v_2 = np.loadtxt("u_rms_alfa0.5_d0.1_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
#modificar os dados do caso2
r_2 = r_2*0.033879363/(0.001/1000)
v_2 = v_2/0.033879363
...
#v_7 = v_7*0.03
#caso3
r_3, v_3 = np.loadtxt("u_rms_alfa0.5_d0.2_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
#modificar os dados do caso2
r_3 = r_3*0.033747842/(0.001/1000)
v_3 = v_3/0.033747842
#caso1
r_5, v_5 = np.loadtxt("u_rms_alfa0.5_d0.5_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
#modificar os dados do caso1
r_5 = r_5*0.034251829/(0.001/1000)
v_5 = v_5/0.034251829
#caso3
...
fig.tight_layout()
#salvar a figura
plt.savefig('flut_urms_norm_alfa05_var_diam_tese_final2.pdf',
            format='pdf')
plt.savefig('flut_urms_norm_alfa05_var_diam_tese_final2.png',
            format='png')
