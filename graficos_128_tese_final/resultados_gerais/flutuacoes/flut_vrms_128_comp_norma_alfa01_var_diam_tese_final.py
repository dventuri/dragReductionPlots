...
v_1 = v_1/0.030236987
#caso2
r_2, v_2 = np.loadtxt("v_rms_alfa_0.1_d0.1_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#v_7 = v_7*0.03
#caso3
r_3, v_3 = np.loadtxt("v_rms_alfa_0.1_d0.2_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
v_3 = v_3/0.030236987
#caso1
r_5, v_5 = np.loadtxt("v_rms_alfa0.1_d0.5_172000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
fig.tight_layout()
#salvar a figura
plt.savefig('flut_vrms_norm_alfa01_var_diam_tese_final1.pdf',
            format='pdf')
plt.savefig('flut_vrms_norm_alfa01_var_diam_tese_final1.png',
            format='png')