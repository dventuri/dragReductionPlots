...
#v_1 = v_1/0.030236987
#caso2
r_2, v_2 = np.loadtxt("mag_vort_alfa05_d01.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#v_7 = v_7*0.03
#caso3
r_3, v_3 = np.loadtxt("mag_vort_alfa05_d02.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#v_3 = v_3
#caso1
r_5, v_5 = np.loadtxt("mag_vort_alfa05_d05.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
#ax.annotate('I', xy=(12.5, 700), xytext=(2.0, 950), size='16'
##            arrowprops=dict(facecolor='black', shrink=0.05),
#            )
#ax.annotate('II', xy=(12.5, 700), xytext=(12.5, 950), size='16'
##            arrowprops=dict(facecolor='black', shrink=0.05),
#            )
#ax.annotate('III', xy=(12.5, 700), xytext=(37.0, 950), size='16'
##            arrowprops=dict(facecolor='black', shrink=0.05),
#            )
#ax.annotate('IV', xy=(12.5, 700), xytext=(80.0, 950), size='16'
##            arrowprops=dict(facecolor='black', shrink=0.05),
#            )
#grafico 2
#ax.plot(r_7, v_7,
...
fig.tight_layout()
#salvar a figura
#plt.savefig('vorticidade_alfa05_var_diam_logx_4.pdf',
#            format='pdf')
#plt.savefig('vorticidade_alfa05_var_diam_logx_4.png',
#            format='png')
