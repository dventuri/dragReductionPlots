...
v_1 = v_1/0.0302353
#caso1
r_5, v_5 = np.loadtxt("giust_dns_wrms.csv",
                      dtype='float',
                      skiprows=0,
                      delimiter=' ',
                      unpack=True)
...
#v_5 = v_5/0.0302353
#caso2
r_2, v_2 = np.loadtxt("yu_wrms_64.csv",
                      dtype='float',
                      skiprows=0,
                      delimiter=' ',
                      unpack=True)
...
#v_7 = v_7*0.03
#caso3
r_3, v_3 = np.loadtxt("dns_pang_wrms1.csv",
                      dtype='float',
                      skiprows=0,
                      delimiter=' ',
                      unpack=True)
...
#grafico 2
ax.plot(r_2, v_2,
        label='$w^{+}_{rms}$ Yu e Kawaguchi (2004)',
        color='red',
        linewidth=1,
        linestyle= '--',
        marker = '',
...
#grafico 1
ax.plot(r_5, v_5,
        label='$w^{+}_{rms}$ Giusti et al. (2005)',
        color='green',
        linewidth=1,
        linestyle='-.')             
#grafico 3
ax.plot(r_3, v_3,
        label='$w^{+}_{rms}$ Pang et al. (2014)',
        color='Black',
        linewidth=1,
        linestyle=':')
#grafico 4
...
fig.tight_layout()
#salvar a figura
plt.savefig('flut_wrms_comp_mono_128_dns_normalizado.pdf',
            format='pdf')
plt.savefig('flut_wrms_comp_mono_128_dns_normalizado.png',
            format='png')