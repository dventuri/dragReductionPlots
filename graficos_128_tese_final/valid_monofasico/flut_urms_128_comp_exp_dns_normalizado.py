...
#ler os dados
#caso1
r_1, v_1 = np.loadtxt("u_rms_mono_128_dt10(-4)_novo_180000.curve",
                      dtype='float',
                      skiprows=2,
                      delimiter=' ',
                      unpack=True)
...
v_1 = v_1/0.0302353
#caso1
#r_5, v_5 = np.loadtxt("giust_dns_urms.csv",
#                      dtype='float',
#                      skiprows=0,
#                      delimiter=' ',
#                      unpack=True)
...
#v_5 = v_5/0.0302353
#caso2
#r_2, v_2 = np.loadtxt("yu_rms_64.csv",
#                      dtype='float',
#                      skiprows=0,
#                      delimiter=' ',
#                      unpack=True)
...
r_7, v_7 = np.loadtxt("u_rms_alfa0.5_d1.csv",
                      dtype='float',
                      skiprows=0,
                      delimiter=' ',
                      unpack=True)
...
#v_7 = v_7*0.03
#caso3
#r_3, v_3 = np.loadtxt("dns_pang_urms.csv",
#                      dtype='float',
#                      skiprows=0,
#                      delimiter=' ',
#                      unpack=True)
...
#v_3 = v_3/0.030487242
#caso3
#r_6, v_6 = np.loadtxt("u_rms_mono_128_dt10(-4)_novo_180000.curve",
#                      dtype='float',r_3, v_3 = np.loadtxt("dns_pang_urms.csv",
#                      dtype='float',
#                      skiprows=0,
#                      delimiter=' ',
#                      unpack=True)
...
ax.set_ylabel("$u^{+}_{rms}$", fontsize=18)
#dimensao dos eixos
ax.axis([0.0, 150.0, 0.0, 3.0])
#grafico 2
ax.plot(r_7, v_7,
...
#grafico 1
ax.plot(r_1, v_1,
        label='$u^{+}_{rms}$ Monofásico',
        color='Blue',
        linewidth=1,
        linestyle='-')
#grafico 2
#ax.plot(r_2, v_2,
#        label='$u^{+}_{rms}$ Yu e Kawaguchi (2004)',
#        color='red',
#        linewidth=1,
#        linestyle= '--',
#        marker = '',
...
#grafico 1
#ax.plot(r_5, v_5,
#        label='$u^{+}_{rms}$ Giusti et al. (2005)',
#        color='green',
#        linewidth=1,
#        linestyle='-.')             
#grafico 3
#ax.plot(r_3, v_3,
#        label='$u^{+}_{rms}$ Pang et al. (2014)',
#        color='Black',
#        linewidth=1,
#        linestyle=':')
#grafico 4
...
fig.tight_layout()
#salvar a figura
plt.savefig('flut_urms_comp_mono_128_dns_normalizado_tste.pdf',
            format='pdf')
plt.savefig('flut_urms_comp_mono_128_dns_normalizado_teste.png',
            format='png')